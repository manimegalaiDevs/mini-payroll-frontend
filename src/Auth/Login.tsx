...
const LoginPage: React.FC = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen p-4">
            ...
            >
                <h1 className="text-2xl font-semibold text-gray-900 text-left">Login</h1>
                ...
                <form onSubmit={handleLogin} className="space-y-8 mt-12">
                    ...
                    <button
                        ...
                        className="w-full flex justify-center items-center py-3 px-4 rounded-lg shadow-md text-xl font-medium text-white hover:bg-opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-150 ease-in-out transform hover:scale-[1.005]"
                        disabled={isLoading}
                    >
                        {isLoading && (
